...
public class DBService {
    ...
    public void instantiateTestDabaBase() throws ParseException {
        ...
        Produto p9 = new Produto(null, "Pendente", 1800.00);
        ...
        Cliente cli1 = new Cliente(null, "Maria Silva", "lcorreia6975@gmail.com",
                "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
        cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

        Cliente cli2 = new Cliente(null, "Roberto Rivelino", "lucasteste6975@gmail.com",
                "44514653896", TipoCliente.PESSOAFISICA, pe.encode("123"));
        cli2.addPerfil(Perfil.ADMIN);
        cli2.getTelefones().addAll(Arrays.asList("99485502", "996783305"));

        Endereco e1 = new Endereco(null, "Rua flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
        Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
        Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "197045862", cli2, c2);
